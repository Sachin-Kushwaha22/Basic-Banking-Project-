    ...
    <nav>
      <div className="main-header">
        <div style={{cursor:'pointer'}} className="logo">
          <div className="logo-img"><img src={logo} alt="" width='50px' /></div>
          <div className="bank-name"><p className="pbc">PBFC</p><p className="bank">BANK</p></div>
        </div>

        <div className="header-contents">
          <ul style={{listStyle:'none'}} className="header-items">
            <a href="/" className="nav-item">HOME</a>
            <a href="/all-customers" className="nav-item">CUSTOMERS</a>
            <a href="/all-transfers" className="nav-item">TRANSACTIONS</a>
          </ul>
        </div>
      </div>
    </nav>
